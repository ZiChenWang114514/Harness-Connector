...
class RepositoryContractTests(unittest.TestCase):
    def test_required_project_files(self):
        for relative in (
            ...
            "references/defaults.json", "references/operation-protocol.md",
            "references/verification.json", "assets/readme/hero.svg",
            "assets/readme/hero-mobile.svg", "assets/readme/pi-logo.svg",
        ):
